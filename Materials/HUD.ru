    ...
    def refresh
      ...
      if Crissaegrim_ABS::Distance_Weapons.has_key?(@actor.weapon_id)
        if Crissaegrim_ABS::Distance_Weapons[@actor.weapon_id][5] > 0
          ...
          self.contents.font.size = 18
          self.contents.font.color = text_color(15)
          self.contents.draw_text(15, 354, 24, 28, $game_party.item_number($data_items[Crissaegrim_ABS::Distance_Weapons[@actor.weapon_id][5]]),1)
          self.contents.font.size = 16
          self.contents.font.color = text_color(0)
          self.contents.draw_text(16, 355, 24, 28, $game_party.item_number($data_items[Crissaegrim_ABS::Distance_Weapons[@actor.weapon_id][5]]),1)
        end
        if Crissaegrim_ABS::Distance_Weapons[@actor.weapon_id][6] > 0
          ...
          self.contents.font.size = 18
          self.contents.font.color = text_color(15)
          self.contents.draw_text(60, 354, 24, 28, $game_party.item_number($data_items[Crissaegrim_ABS::Distance_Weapons[@actor.weapon_id][6]]),1)
          self.contents.font.size = 16
          self.contents.font.color = text_color(0)
          self.contents.draw_text(61, 355, 24, 28, $game_party.item_number($data_items[Crissaegrim_ABS::Distance_Weapons[@actor.weapon_id][6]]),1)
        end
      end
    end
