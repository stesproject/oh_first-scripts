...
module Wora_NSS
  ...
  SAVED_SLOT_ICON = 16 # IconaIndex per il save slot
  EMPTY_SLOT_ICON = 32 # Colore per lo slot vuoto
  ...
  DRAW_LEVEL = true # Mostra livello giocatore
  ...
  def draw_data(slot_id)
    ...
    save_data['gamemap'].display_y)
      ...
      if DRAW_LOCATION
        ...
        if DRAW_NAME
          # Draw Name
          actor_name = $local.get_text("Ourhero")
